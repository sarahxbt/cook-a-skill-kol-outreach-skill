...
| **BEFORE: manual process** | BD receives a product spec → scrolls through each KOL's Twitter → evaluates fit by gut feel (good match or not?) → writes a generic copy-paste DM for all. **Takes 3–4 hours for 10–15 KOLs**, low outreach quality, inconsistent personalization. |
